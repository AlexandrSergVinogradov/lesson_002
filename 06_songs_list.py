...
all_time_dict = violator_songs_dict['Sweetest Perfection']+violator_songs_dict['Policy of Truth']+violator_songs_dict['Blue Dress']
print('А другие три песни звучат', round(all_time_dict,2),'минут')
